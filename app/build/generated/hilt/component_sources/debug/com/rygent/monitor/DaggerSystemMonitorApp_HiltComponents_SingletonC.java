...
import com.rygent.monitor.service.MonitoringService;
import com.rygent.monitor.service.MonitoringService_MembersInjector;
...
public final class DaggerSystemMonitorApp_HiltComponents_SingletonC {
  ...
  private static final class ServiceCImpl extends SystemMonitorApp_HiltComponents.ServiceC {
    ...
    private MonitoringService injectMonitoringService2(MonitoringService instance) {
      MonitoringService_MembersInjector.injectRepository(instance, singletonCImpl.bindDeviceRepositoryProvider.get());
      MonitoringService_MembersInjector.injectSettingsManager(instance, singletonCImpl.settingsManagerProvider.get());
      MonitoringService_MembersInjector.injectNotificationHelper(instance, singletonCImpl.notificationHelperProvider.get());
      return instance;
    }
  }
