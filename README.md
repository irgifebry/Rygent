...
**Rygent Mobile** is a system monitoring client app that allows you to monitor the real-time status of your PC/Server (Linux) directly from your Android device. It pairs perfectly with the "Rygent Agent" running on your computer.
